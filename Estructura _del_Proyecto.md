...
Esta guía de implementación cuenta con las siguientes páginas, donde cada una de ellas contiene lo siguiente:

1. **Página de inicio:** Contiene el alcance de la guía, contexto, descripción, contenido de la guía y aspectos generales. Este último punto hace referencia al **proceso de solicitud de resumenes clínicos de pacientes**, el cual abarca el flujo de datos desde que el profesional de la salud solicita el resumen del paciente por medio del sistema local hacia el repositorio IPS, hasta que el resumen es creado y enviado al sistema local para su visualización. Esto se puede observar en la siguiente imagen.
